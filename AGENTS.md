...
- Shared product language and architectural decisions live in `CONTEXT.md` and `docs/adr/` when present. Check these before renaming domain concepts or changing boundaries.
